...
export class AuthenticationService {
  ...
  // changePassword(changePasswordRequest: ChangePasswordRequest, connectedUser: Princilal){
  //   return this.http.post<ChangePasswordRequest>()
  // }


  changePassword(request: any) {
    return this.http.patch('http://localhost:8082/api/v1/users', request);
  }
